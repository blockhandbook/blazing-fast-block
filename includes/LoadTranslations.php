 ...
 *
 * @package BlazingFastBlock
 */

namespace BlazingFastBlock;
...
class LoadTranslations {
	...
	public function load_script_translations() {
		...
		if ( function_exists( 'wp_set_script_translations' ) ) {
			wp_set_script_translations(
				BLAZING_FAST_BLOCK_PLUGIN_SLUG . '-block-editor',
				BLAZING_FAST_BLOCK_PLUGIN_SLUG,
				BLAZING_FAST_BLOCK_PLUGIN_PATH . 'languages'
			);
		}
	}
	...
	public function load_php_translations() {
		...
		load_plugin_textdomain(
			BLAZING_FAST_BLOCK_PLUGIN_TEXTDOMAIN,
			false,
			BLAZING_FAST_BLOCK_PLUGIN_SLUG . '/languages'
		);
	}
}
